...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        @endif
          <h5 class="fw-bolder">Ringkasan Data Pengalaman</h5>
          <table class="table">
            ...
            <a style="text-decoration: none" href="{{ route('experience.create') }}">+ Buat Data Informasi Baru</a>
         </form>
          {!! $experiences->links() !!}
       </div>
       <div class="col-12 step d-flex justify-content-between mt-3">
        <a href="{{ route('information.index') }}" class="btn btn-outline-primary text-uppercase btn-prev">Kembali</a>
        <a href="{{ route('education.index') }}" class="btn btn-primary ml-auto text-uppercase btn-next">Berikutnya</a>
      </div>
       </div>
       </div>
