...
<html lang="en">
  <head>
    ...
    <title>Platform Pembuatan CV ATS FRIENDLY | Kemampuan</title>
  ...
  <body>
    <div class="container">
        ...
        @endif
          <h5 class="fw-bolder">Ringkasan Data Kemampuan</h5>
          <table class="table">
            ...
            <a style="text-decoration: none" href="{{ route('skill.create') }}">+ Buat Data Kemampuan Baru</a>
         </form>
          {!! $skills->links() !!}
        </div>
        <div class="col-12 step d-flex justify-content-between mt-3">
          <a href="{{ route('organization.index') }}" class="btn btn-outline-primary text-uppercase btn-prev">Kembali</a>
          <a href="{{ route('language.index') }}" class="btn btn-primary ml-auto text-uppercase btn-next">Berikutnya</a>
        </div>
       </div>
       </div>
