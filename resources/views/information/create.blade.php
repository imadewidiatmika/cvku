            ...
            <form action="{{ route('information.store') }}" class="form" method="POST">
                @csrf
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="phoneNum" name="phoneNum"  value="{{ old('phoneNum') }}">
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="profesion" name="profesion"  value="{{ old('profesion') }}">
                    @error('profesion') <span class="error">{{ $message }}</span> @enderror
                  </div>
                  <div class="col-12">
                    <label for="linked" class="form-label">LinkedIn Profile URL </label>
                    <input type="text" class="form-control" id="linked" name="linked"  value="{{ old('linked') }}">
                    @error('linked') <span class="error">{{ $message }}</span> @enderror
                  </div>
                  <div class="col-12">
                    <label for="portfolio" class="form-label">Portfolio/Website URL </label>
                    <input type="text" class="form-control" id="portfolio" name="portfolio"  value="{{ old('portfolio') }}">
