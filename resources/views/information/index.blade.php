...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        @endif
          <h5 class="fw-bolder">Ringkasan Data Pribadi</h5>
          <table class="table">
              ...
              <tr>
                  ...
                  <td style="text-align: right">
                      <form action="{{ route('information.destroy',$information->id) }}" method="POST">
                          ...
                          <a class="btn btn-primary" href="{{ route('information.edit',$information->id) }}">Edit</a>
            ...
            <a style="text-decoration: none" href="{{ route('information.create') }}">+ Buat Data Informasi Baru</a>
         </form>
          {!! $informations->links() !!}
        </div>
          <div class="col-12 step d-flex justify-content-between mt-3">
            <a href="{{ route('experience.index') }}" class="btn btn-primary ml-auto text-uppercase btn-next">Berikutnya</a>
          </div>
       </div>
       </div>
