  ...
  <body>
    <div class="container">
          <div class="row">
            ...
            <form action="{{ route('certificate.update', $certificate) }}" class="form" method="POST">
                @csrf
                @method('PUT')
                <h5 class="fw-bolder">Sertifikat</h5>
                <p>Masukkan sertifikat yang kamu punya ya</p>
                            <div class="col-12">
                              <label for="certificate" class="form-label">Sertifikat</label>
                              <input type="text" class="form-control" id="certificate" name="certificate"  value="{{ $certificate->certificate }}">
